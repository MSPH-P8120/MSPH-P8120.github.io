...
This example uses a dataset builds a cross-tabulation from summary data. The variable 'ncontrols' contains the counts per group which is why it is before the tilda.
...
|-----------------------|--------------------|----------|:---------:|
|Odds ratio (2xk table) | `oddsratio()`      | epitools |[5](measures_association.html)    |
|Risk ratio (2xk table) | `riskratio()`      | epitools |[5](measures_association.html)    |
|Risk difference        | `riskdiff()`       | catfun   |[5](measures_association.html)    |
