...
Use the following table to locate functions for hypothesis tests. If you are unsure of the usage of a function type `?<insert function>`. For many of these tests, there are multiple functions that one could use; these are the one's we have found to work best. 
...
|Liklihood ratio test                             | `GTest()`                         | DescTools     | [9](lrt_2_sample.html)                  |
|Two sample test for proportions                  | `prop_test()`                     | catfun        | [9](lrt_2_sample.html)                  |
|McNemar's test                                   | `CrossTable(..., mcnemar = TRUE)` | descr         |                                         |
...
|------------------------------------|---------------------|------------------|:---------------------------------:|
| Power from sample size             | `pwr.2p.test()`     | pwr              | [10](power.html)                  |
| Sample size from power (balanced)  | `pwr.2p.test()`     | pwr              | [10](power.html)                  |
| Sample size from power (unbalanced)| TBD                 | TBD              | [10](power.html)                  |
