...
To conduct a hypothesis test for a single proportion in SAS you use the frequency procedure. For further help, please watch the video [example](#video-example).
