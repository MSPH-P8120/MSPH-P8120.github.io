...
SAS is available on all computers at the CUMC library or can be purchased through the IT department in the Hammer Library for $85 (Windows computers only). In addition, there is now a free version of SAS that works on multiple operating systems called SAS University Edition. Instructions for download can be found [here](https://www.dropbox.com/referrer_cleansing_redirect?hmac=cxF93jVNXPpoZWrA2SBuSWWWeyeOSH7oaGdKbbuS0DI%3D&url=https%3A%2F%2Fwww.sas.com%2Fen_us%2Fsoftware%2Funiversity-edition.html). Another free option is SAS OnDemand, which some students may already be using in P8483. Instructions to download and use the software can be found [here](https://www.dropbox.com/referrer_cleansing_redirect?hmac=IA9dIx9JzInqhe3XNgAM%2B4pMGQ9t5NxCv%2Fa0YBHd078%3D&url=https%3A%2F%2Fwww.sas.com%2Fen_us%2Fsoftware%2Fon-demand-for-academics.html%23for-students-).
...
When starting a new session the basic workflow is: open a new program, type some code, run code, export necessary procedures, and of course save work often. To open a new program use File > New Program; to run code highlight the code of interest and click the running individual on the toolbar; to save a program use File > Save As....  
...
|GOF & Hosmer Lemeshow                            |`proc logistic`     |                                     | 16                               |
|Breslow Day test                                 |`proc freq`         |                                     | 19                               |
