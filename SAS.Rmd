...
|Fisher's exact                      | `proc freq` | Same as chi-squared test | [8](chi_squared_fisher.html) |
|Likelihood ratio test               | `proc freq` | Same as chi-squared test | [9](lrt_2_sample.html) |
