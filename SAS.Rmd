...
Always remember to save your work often. To open a new program use File > New Program; to run code highlight the code of interest and click the running individual on the toolbar; to save a program use File > Save As....  
