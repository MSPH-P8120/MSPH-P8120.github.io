...
|------------------------------------|--------------------------------|------------------|:-----------------:|
|Confidence intervals, proportions   | `proc freq` | Same as normal and exact tests |[3](ci_single_proportion.html)|
|One sample test proportions, normal approximation  | `proc freq` | `binomial(p = <insert null>)` |[4](hypothesis_single_prop.html)|
|One sample test proportions, exact   |  `proc freq` | Same as normal approx., also requires `exact binomial` |[4](hypothesis_single_prop.html)|
...
|-----------------------|--------------------|------------------|-----------------|
|Odds ratio (2xk table) | `proc freq`        | `relrisk`        |[5](measures_association.html) 
|Risk ratio (2xk table) | `proc freq`        | `relrisk`        |[5](measures_association.html) 
|Risk difference        | `proc freq`        | `riskdiff`       |[5](measures_association.html) 
### Power
