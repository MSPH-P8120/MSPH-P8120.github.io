...
| Power analysis                     | SAS procedure       | Arguments needed | Lecture          |
|------------------------------------|---------------------|------------------|:----------------:|
| Power from sample size             | `proc power`        | `relrisk`        | [10](power.html) |
| Sample size from power (balanced)  | `proc power`        | `relrisk`        | [10](power.html) |
| Sample size from power (unbalanced)| `proc power`        | `riskdiff`       | [10](power.html) |
